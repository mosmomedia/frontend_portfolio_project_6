		...
		return `
			<div id='about' class='card-header'>
				<div>
					...
					<div id='about_desc'>
					<p>이 프로젝트는 <a id='about_link' href='https://zuminternet.github.io/zum-front-recurit-review/' target='blank'>줌인터넷의 주니어 프론트엔드 개발자 채용 과제</a>를 바탕으로 만들었습니다</p>
					<p>리엑트 프레임워크와 클론 코딩 중심의 포트폴리오를 완성 후 채용 프로세스 및 이력서 관련 검색 중에 이 블로그의 포스트를 보았습니다. 이 회사가 정의하는 주니어 개발자의 역량에 부합하고자 이 프로젝트를 포트폴리오에 추가했습니다.</p>
